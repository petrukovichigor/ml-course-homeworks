# Домашнее задание: Разведывательный анализ данных (EDA)
...
- 🚢 **Titanic** ([https://www.kaggle.com/competitions/titanic](https://www.kaggle.com/competitions/titanic)) — классика, много категорий + пропуски.
- 🏠 **House Prices** ([https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques](https://www.kaggle.com/competitions/house-prices-advanced-regression-techniques)) — куча признаков, супер-практика по статистике и выбросам.
- 🍿 **Netflix Movies & TV Shows** ([https://www.kaggle.com/datasets/shivamb/netflix-shows](https://www.kaggle.com/datasets/shivamb/netflix-shows)) — работа с текстами, датами и категориями.
- 🗽 **NYC Airbnb** ([https://www.kaggle.com/datasets/dgomonov/new-york-city-airbnb-open-data](https://www.kaggle.com/datasets/dgomonov/new-york-city-airbnb-open-data)) — цены, районы, выбросы, корреляции.
...
> **Важно:** В начале ноутбука не забудьте оставить ссылку на скачивание датасета и пару строк о том, что это за данные.
